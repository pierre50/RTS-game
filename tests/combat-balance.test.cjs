...
test('hero and human units have explicit stamina pacing', () => {
  assert.equal(units.Hero.totalEnergy, 20)
  assert.equal(units.Hero.energyRegenRate, 4)
  assert.equal(units.Hero.energyRegenDelay, 400)
  assert.equal(units.Hero.energyCosts.attack, 1)
  assert.equal(units.Hero.energyCosts.heroWhiff, 0.25)
  assert.equal(units.Hero.energyCosts.heroPowerCharge, 1.5)
  assert.equal(units.Hero.energyCosts.heroDefense, 1.25)
  assert.equal(units.Hero.energyCosts.chopwood, 1)
  assert.equal(units.Hero.energyCosts.minestone, 1.25)
  assert.equal(units.Hero.energyCosts.minegold, 1.25)
  assert.equal(units.Hero.energyCosts.minecopper, 1.25)
  assert.equal(units.Hero.energyCosts.mineiron, 1.25)
  assert.equal(units.Hero.energyCosts.build, 1)
  assert.equal(units.Hero.energyCosts.forageberry, 0.5)
  assert.equal(units.Hero.energyCosts.farm, 0.5)
  assert.equal(units.Hero.energyCosts.takemeat, 0.25)

  assert.equal(units.Villager.totalEnergy, 12)
  assert.equal(units.Villager.energyRegenRate, 2.5)
  assert.equal(units.Villager.energyRegenDelay, 500)
  assert.equal(units.Villager.energyCosts.attack, 2)
  assert.equal(units.Villager.energyCosts.chopwood, 1.25)
  assert.equal(units.Villager.energyCosts.minestone, 1.5)
  assert.equal(units.Villager.energyCosts.minegold, 1.5)
  assert.equal(units.Villager.energyCosts.build, 1.25)
  assert.equal(units.Villager.energyCosts.forageberry, 0.5)
  assert.equal(units.Villager.energyCosts.farm, 0.75)
  assert.equal(units.Villager.energyCosts.takemeat, 0.5)

  assert.equal(units.Fantassin.totalEnergy, 12)
  assert.equal(units.Fantassin.energyCosts.attack, 1.75)
  ...
  assert.equal(units.Chief.energyCosts.attack, 1.75)
