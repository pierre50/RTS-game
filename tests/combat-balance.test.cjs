...
test('level-one hero uses the human stamina baseline', () => {
  ...
  assert.equal(units.Villager.energyCosts.chopwood, 0.65)
  assert.equal(units.Villager.energyCosts.minestone, 0.75)
  assert.equal(units.Villager.energyCosts.minegold, 0.75)
  assert.equal(units.Villager.energyCosts.build, 1.3)
  assert.equal(units.Villager.energyCosts.forageberry, 0.25)
  assert.equal(units.Villager.energyCosts.farm, 0.4)
  assert.equal(units.Villager.energyCosts.takemeat, 0.25)
