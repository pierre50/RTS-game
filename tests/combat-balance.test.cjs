...
test('hero and human units have explicit stamina pacing', () => {
  ...
  assert.equal(units.Hero.energyRegenRate, 5)
  assert.equal(units.Hero.energyRegenDelay, 320)
  assert.equal(units.Hero.energyCosts.attack, 1)
  assert.equal(units.Hero.energyCosts.heroWhiff, 0.3)
  assert.equal(units.Hero.energyCosts.heroPowerCharge, 1.5)
  assert.equal(units.Hero.energyCosts.heroDefense, 1.3)
  assert.equal(units.Hero.energyCosts.chopwood, 1)
  assert.equal(units.Hero.energyCosts.minestone, 1.3)
  assert.equal(units.Hero.energyCosts.minegold, 1.3)
  assert.equal(units.Hero.energyCosts.minecopper, 1.3)
  assert.equal(units.Hero.energyCosts.mineiron, 1.3)
  ...
  assert.equal(units.Hero.energyCosts.takemeat, 0.3)
