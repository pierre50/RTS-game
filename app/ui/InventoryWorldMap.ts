...
function settlementPlayerColor(menu: MenuHost, settlement: MacroWorldSettlement): string | null {
...
function createWorldMapLegend(menu: MenuHost, manifest: MacroWorldManifest): HTMLElement | null {
