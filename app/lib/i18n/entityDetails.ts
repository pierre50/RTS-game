export const ENTITY_DETAILS_TRANSLATIONS = {
  fr: {
    ...
    CampArrowBasketDescription: 'Panier de flèches posé dans le camp.',
    CampAppleBasketDescription: 'Panier de pommes posé dans le camp.',
    CampBenchDescription: 'Banc installé dans le camp.',
    CampRoundStoolDescription: 'Tabouret rond de camp.',
    CampChairDescription: 'Chaise installée dans le camp.',
    CampThroneDescription: 'Siège imposant installé dans le camp.',
    CampBrazierDescription: 'Brasero installé dans le camp.',
    CampBlueJarDescription: 'Jarre bleue rangée dans le camp.',
    CampScreenDescription: 'Paravent séparant les espaces du camp.',
    CampWeavingTableDescription: 'Table de tissage installée dans le camp.',
    CampSquareStoolDescription: 'Tabouret carré de camp.',
    CampStumpStoolDescription: 'Souche utilisée comme siège de camp.',
    CampMountedSkullDescription: 'Crâne exposé comme ornement du camp.',
    CampTorchStandDescription: 'Support de torche installé dans le camp.',
    CampFruitBowlDescription: 'Coupe de fruits posée dans le camp.',
    CampBedrollDescription: 'Couchage de camp pour se reposer.',
  ...
  en: {
    ...
    CampArrowBasketDescription: 'A basket of arrows in the camp.',
    CampAppleBasketDescription: 'A basket of apples in the camp.',
    CampBenchDescription: 'A bench in the camp.',
    CampRoundStoolDescription: 'A round camp stool.',
    CampChairDescription: 'A chair in the camp.',
    CampThroneDescription: 'An imposing seat in the camp.',
    CampBrazierDescription: 'A brazier in the camp.',
    CampBlueJarDescription: 'A blue jar stored in the camp.',
    CampScreenDescription: 'A screen dividing areas of the camp.',
    CampWeavingTableDescription: 'A weaving table in the camp.',
    CampSquareStoolDescription: 'A square camp stool.',
    CampStumpStoolDescription: 'A stump used as a camp seat.',
    CampMountedSkullDescription: 'A skull displayed as a camp ornament.',
    CampTorchStandDescription: 'A torch stand in the camp.',
    CampFruitBowlDescription: 'A bowl of fruit in the camp.',
    CampBedrollDescription: 'A camp bedroll for resting.',
