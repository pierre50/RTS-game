...
export const BUILDING_TYPES = {
  ...
  campTable: 'CampTable',
  campWorkbench: 'CampWorkbench',
  campForge: 'CampForge',
  campAlchemyTable: 'CampAlchemyTable',
  campSupplyShelf: 'CampSupplyShelf',
  campBookcase: 'CampBookcase',
  campArrowBasket: 'CampArrowBasket',
  campAppleBasket: 'CampAppleBasket',
  campBench: 'CampBench',
  campRoundStool: 'CampRoundStool',
  campChair: 'CampChair',
  campThrone: 'CampThrone',
  campBrazier: 'CampBrazier',
  campBlueJar: 'CampBlueJar',
  campScreen: 'CampScreen',
  campWeavingTable: 'CampWeavingTable',
  campSquareStool: 'CampSquareStool',
...
export const CAMP_DECORATION_BUILDING_TYPES = [
  ...
  BUILDING_TYPES.campBedroll,
  BUILDING_TYPES.campTable,
  BUILDING_TYPES.campWorkbench,
  BUILDING_TYPES.campForge,
  BUILDING_TYPES.campAlchemyTable,
  BUILDING_TYPES.campSupplyShelf,
  BUILDING_TYPES.campBookcase,
  BUILDING_TYPES.campArrowBasket,
  BUILDING_TYPES.campAppleBasket,
  BUILDING_TYPES.campBench,
  BUILDING_TYPES.campRoundStool,
  BUILDING_TYPES.campChair,
  BUILDING_TYPES.campThrone,
  BUILDING_TYPES.campBrazier,
  BUILDING_TYPES.campBlueJar,
  BUILDING_TYPES.campScreen,
  BUILDING_TYPES.campWeavingTable,
  BUILDING_TYPES.campSquareStool,
