...
const mappings = [
  ...
  ['322', 'units/chariot/dying'],
  ['381', 'units/chariot/corpse'],
  ...
  ['474', 'boats/fishing-ship'],
  ['700', 'boats/fishing-ship/fishing-overlay'],
  ['263', 'boats/wrecks/medium'],
  ['647', 'boats/light-transport'],
  ['648', 'boats/heavy-transport'],
  ['692', 'boats/scout-ship'],
  ['691', 'boats/war-galley'],
  ['264', 'boats/wrecks/large'],
  ['693', 'boats/trireme'],
  ['695', 'boats/juggernaut'],
  ['583', 'boats/shared/sail-5-direction'],
  ['584', 'boats/shared/sail-9-direction'],
